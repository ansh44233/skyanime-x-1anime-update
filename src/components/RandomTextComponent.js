...
const RandomTextComponent = () => {
  const randomTexts = [
    { text: "Enjoying SkyAnime X 1Anime? Help us keep our site alive by donating or sharing the app!", link: "https://1anime.co/donate" },
    { text: "Have you tried customizing the app with Themes? Try Themes if you haven't!", link: "/settings" },
    { text: "Did you know? SkyAnime X 1Anime secures your AniList account when you sync?", link: "/user/profile" },
